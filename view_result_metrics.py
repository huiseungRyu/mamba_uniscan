...
# 저장된 결과 파일 경로
results_root = "/media/NAS/nas_187/huiseung/prediction_results/assb_glbtoken_3d/result_metrics" #Causal_adventurer"#DEMISTIFYING"#assm_only"#base_new" #"/media/NAS/nas_187/huiseung/prediction_results/segmamba"
...
result_path = os.path.join(results_root, f"{pred_name}.npy")
results = np.load(result_path) #result_path  # shape: (250, 3, 2)
